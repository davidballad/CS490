...
else
{
    ...
    foreach ($testCases as $tc)
    {
        ...
        fwrite($studentFile, "#Grade at this Point is : $grade/$total\n");
        fwrite($studentFile, "#TestCase:  $trimVars\n");
        fwrite($studentFile, "#DB Answer: $ans\n");
        fwrite($studentFile, $answer); //STUDENT ANSWER / INPUT
        fwrite($studentFile, "\n");
...
fwrite($outFile, "\n");
fwrite($outFile, "Student's Answer: \n $answer\n");
fwrite($outFile, "\n");
fwrite($outFile, "Python output: $run\n");
fwrite($outFile, "PRINT THE WEIRD ANSWER: $ans");
fwrite($outFile, "\n");
fwrite($outFile, "GRADE PRINTED $grade\n");
fwrite($outFile, " cf $cf\npf $pf\ncw $cw\npw $pw\ncp $cp\n pp $pp");
fwrite($outFile, "\n");
fwrite($outFile, "DBDATA : print_r($DBdata)\n\n\n");
fwrite($outFile, "This is fpos $fpos, bpos $bpos \n This is Function given by student $functionTrimmed \n\n check this $defFunction\n");
fclose($outFile);
